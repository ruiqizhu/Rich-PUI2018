...
! function(e, t) {
    ...
    function b(e) {
        var t = J,
            n = Ie[e];
        return n || (n = x(e, t), "none" !== n && n || (We = (We || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = We[0].contentDocument, t.write(), t.close(), n = x(e, t), We.detach()), Ie[e] = n), n
    }
    ...
    function q(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], l = Z.css(e, "display"), c = "none" === l ? ve.get(e, "olddisplay") || b(e.nodeName) : l, "inline" === c && "none" === Z.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", f.always(function() {
    ...
    var ie = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : I) !== q && L(t), t = t || q, n = n || [], a = t.nodeType, "string" != typeof e || !e || 1 !== a && 9 !== a && 11 !== a) return n;
            if (!r && O) {
                if (11 !== a && (i = ye.exec(e)))
                    if (s = i[1]) {
                        if (9 === a) {
                ...
                if (w.qsa && (!F || !F.test(e))) {
                    if (p = f = W, h = t, g = 1 !== a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (l = N(e), (f = t.getAttribute("id")) ? p = f.replace(be, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", u = l.length; u--;) l[u] = p + d(l[u]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (s) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (u = t[W] || (t[W] = {}), (a = u[r]) && a[0] === $ && a[1] === o) return l[2] = a[2];
        ...
        var b, w, T, C, k, N, E, j, S, D, A, L, q, H, O, F, P, M, R, W = "sizzle" + 1 * new Date,
            I = e.document,
            $ = 0,
            B = 0,
            _ = n(),
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return r !== q && 9 === r.nodeType && r.documentElement ? (q = r, H = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), O = !k(r), w.attributes = i(function(e) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === I && R(I, e) ? -1 : t === r || t.ownerDocument === I && R(I, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (c = m[W] || (m[W] = {}), l = c[e] || [], p = l[0] === $ && l[1], d = l[0] === $ && l[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (d = p = 0) || h.pop();)
                                    if (1 === f.nodeType && ++d && f === t) {
                                        c[e] = [$, p, d];
                                        break
                                    }
                            } else if (y && (l = (t[W] || (t[W] = {}))[e]) && l[0] === $) d = l[1];
                            else
                                for (;
                                    (f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[W] || (f[W] = {}))[e] = [$, d]), f !== t)););
    ...
    Z.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, s, a, u, l, c, f, d, p, h, g, m = ve.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = Z.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                    ...
                    }), t = (t || "").match(pe) || [""], l = t.length; l--;) a = De.exec(t[l]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p && (f = Z.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = Z.event.special[p] || {}, c = Z.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        remove: function(e, t, n, r, i) {
            var o, s, a, u, l, c, f, d, p, h, g, m = ve.hasData(e) && ve.get(e);
            if (m && (u = m.events)) {
                for (t = (t || "").match(pe) || [""], l = t.length; l--;)
                    if (a = De.exec(t[l]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Se.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, t = t[Z.expando] ? t : new Z.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[p] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !Z.isWindow(r)) {
                    for (u = f.delegateType || p, Se.test(u + p) || (s = s.parentNode); s; s = s.parentNode) d.push(s), a = s;
    ...
    Re.optgroup = Re.option, Re.tbody = Re.tfoot = Re.colgroup = Re.caption = Re.thead, Re.th = Re.td, Z.extend({
        ...
        domManip: function(e, t) {
            ...
            var n, r, i, o, s, a, u = 0,
                ...
                d = e[0],
                g = Z.isFunction(d);
            if (g || l > 1 && "string" == typeof d && !Q.checkClone && Oe.test(d)) return this.each(function(n) {
                var r = c.eq(n);
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = Z.camelCase(t),
                    u = e.style;
                return t = Z.cssProps[a] || (Z.cssProps[a] = C(u, a)), s = Z.cssHooks[t] || Z.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Ve.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), void(null != n && n === n && ("number" !== o || Z.cssNumber[a] || (n += "px"), Q.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n))))
            }
        },
    ...
    Z.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && jt.test(this.nodeName) && !Et.test(e) && (this.checked || !ke.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
    ...
    Z.offset = {
        ...
        offset: function(e) {
            ...
            var t, n, r = this[0],
                ...
                o = r && r.ownerDocument;
            return o ? (t = o.documentElement, Z.contains(t, r) ? (typeof r.getBoundingClientRect !== Ne && (i = r.getBoundingClientRect()), n = $(o), {
...
function(e) {
    ...
    e(document).ready(function() {
        function t() {
            n(), e(".video").fitVids(), e(window).load(function() {
                u(), y && initDunkedLightbox(".gallery", !0)
            })
        }
        ...
        function n() {
            ...
            }), g[0].addEventListener("click", function(t) {
                var n = t.target;
                d && n !== m[0] && !e(n).parents("#modal-content").length && (history.pushState(null, null, "/"), i())
            })
        }

        function r() {
            d = !0, l.addClass("show-modal"), g.animate({
                scrollTop: 0
            }, 300), g.addClass("modal--show"), v.addClass("loading--show"), m.addClass("modal-content--show")
        }

        function i() {
            d = !1, m.find(".project").removeClass("project--show"), setTimeout(function() {
                m.html(""), f.removeClass("button--close--show"), m.removeClass("modal-content--show"), l.removeClass("show-modal"), g.css("-webkit-overflow-scrolling", "auto"), g.removeClass("modal--show")
            }, 400)
        }

        function o() {
            v.removeClass("loading--show"), m.find(".project").addClass("project--show"), f.addClass("button--close--show"), setTimeout(function() {
                g.css("-webkit-overflow-scrolling", "touch")
            }, 250)
        }

        function s() {
            r(), setTimeout(function() {
                m.find(".project").removeClass("project--show"), setTimeout(function() {
                    m.html("")
                }, 400)
            }, 300), f.removeClass("button--close--show"), v.addClass("loading--show")
        }

        function a(t) {
            e.get(t, function(t) {
                var n = e(t).find("#ajax-content"),
                    r = e(n).attr("data-id");
                if (m.html(n), picturefill(), e(".video").fitVids(), n.find("img").length > 0 ? n.find("img").on("load", function() {
                        o()
                    }) : setTimeout(function() {
                        o()
                    }, 200), y) {
                    var i = n.find(".gallery").attr({
                        "data-pswp-uid": r
                    });
                    i.length && initDunkedLightbox(".gallery", !0)
                }
            })
        }

        function u() {
            e("#loading-body").fadeOut("300", function() {
                e(this).removeClass("loading--show")
            }), h.find(".brick").each(function(t) {
                var n = e(this),
                    r = Math.floor(100 * Math.random() + 101) * t;
                setTimeout(function() {
                    n.addClass("brick--show"), setTimeout(function() {
                        "no-image" !== n.data("img-url") && n.css({
                            "background-image": "url(" + n.data("img-url") + ")"
                        })
                    }, r + 20)
                }, r)
            })
        ...
        var l = e("body"),
            ...
            f = e(c),
            d = !1,
            p = e(".list-pages").find("a").not('[data-link-type="page-redirect"]'),
            h = e("#ajax-projects-feed"),
            g = (e(".project"), e("#modal")),
            m = e("#modal-content"),
            v = e("#loading"),
            y = l.hasClass("lightbox-enabled");
        h.on("click", ".project a", function(t) {
            //t.preventDefault(), history.pushState(null, null, this.href), r(), a(e(this).attr("href"))
        }), p.on("click", function(t) {
            //t.preventDefault(), history.pushState(null, null, this.href), r(), a(e(this).attr("href"))
        }), e(window).on("popstate", function(e) {
            var t = history.location || document.location;
            if ("/" != t.pathname) {
                h.find('.project a[href="' + t.href + '"]');
                s(), a(t.href)
            } else d && i()
        }), t()
    })
